...
public class Thursday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pAdapter = new Adapter(Thursday.this, listProduct); //Создаем объект нашего адаптера
    ...
    private class GetProducts extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("https://ngknn.ru:5001/NGKNN/зеленцовдр/api/Thursdays");//Строка подключения к нашей API
