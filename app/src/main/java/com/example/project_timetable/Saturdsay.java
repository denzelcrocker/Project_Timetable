...
public class Saturdsay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_saturdsay);
        ListView ivProducts = findViewById(R.id.timetable);//Находим лист в который будем класть наши объекты
        pAdapter = new Adapter(Saturdsay.this, listProduct); //Создаем объект нашего адаптера
    ...
    private class GetProducts extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("https://ngknn.ru:5001/NGKNN/зеленцовдр/api/Saturdays");//Строка подключения к нашей API
    ...
    public void Go() {
        startActivity(new Intent(this, Edit_saturday.class));
    }
