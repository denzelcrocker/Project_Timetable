...
public class Monday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pAdapter = new Adapter(Monday.this, listProduct); //Создаем объект нашего адаптера
    ...
    private class GetProducts extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("https://ngknn.ru:5001/NGKNN/зеленцовдр/api/Mondays");//Строка подключения к нашей API
    ...
    public void Go() {
        startActivity(new Intent(this, Edit_monday.class));
    }
