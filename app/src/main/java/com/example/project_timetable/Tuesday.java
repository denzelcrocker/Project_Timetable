...
public class Tuesday extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pAdapter = new Adapter(Tuesday.this, listProduct); //Создаем объект нашего адаптера
    ...
    private class GetProducts extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... voids) {
            try {
                URL url = new URL("https://ngknn.ru:5001/NGKNN/зеленцовдр/api/Tuesdays");//Строка подключения к нашей API
    ...
    public void Go() {
        startActivity(new Intent(this, Edit_tuesday.class));
    }
